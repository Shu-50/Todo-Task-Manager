...
// import { MdDeleteForever, MdOpacity } from "react-icons/md";
...
// const SavetoLS=(e) =>{                          // to save tasks to Local Storage
...
//     setTodo(t[0].todo)
//     let newTodos = todos.filter(item =>{  //to delete previous task(todo) which is going to update
//       return item.id !== id
//     })
//     setTodos(newTodos)
//     SavetoLS()
...
//     // console.log(`the ID is ${id}`) //check id to delete
...
//   const handleAdd = () => {
//     setTodos([...todos, { id: uuidv4(), todo, isCompleted: false }])  //add current todo
//     setTodo("")
//     // console.log(todos)
//     SavetoLS()
//   }
...
//     //console.log(`the ID is ${id}`)  //to check id
//     let index = todos.findIndex(item => {
//       return item.id === id;
//     })
//     //  console.log(index)
//     let newTodos = [...todos]; // create Array to create new todos (object) else it will only take same referance
...
//   // const showFinished = todos.filter(item => item.isCompleted === true)
//   const [showFinished, setShowFinished] = useState(true)
//   const [circleColor, setCircleColor] = useState('black'); // Default color
//   const toggleFinished = (e) => {
//     setShowFinished(!showFinished)

//     setCircleColor(circleColor === 'black' ? 'white' : 'black'); //to change color of icon
//   }
...
//           <button onClick={handleAdd}  disabled={todo.length<1} className=' disabled:bg-cyan-700 bg-blue-900 hover:bg-blue-600 p-2 py-2 text-sm font-bold text-white rounded-md mx-auto w-3/4'>Save</button>
//         </div>
//         <div className='flex align-center '>
//         <label className='flex items-center gap-1'>
//           <input  onChange={toggleFinished} type="checkbox" style={{display:"none"}} checked={showFinished} className='m-4 '/> 
...
//             return (showFinished || !item.isCompleted) && <div key={item.id} className='todo flex md:w-2/3  my-3 justify-between '>
//               <div className='flex gap-5 md:text-lg'>
//               <input onChange={handleCheckbox} type='checkbox' checked={item.isCompleted} name={item.id} id="" />
//               <div style={{ wordWrap: 'anywhere' }} className={item.isCompleted ? "line-through" : ""}>{item.todo}</div>
//               </div>
//               <div className='buttons flex h-full'>
//                 <button onClick={(e)=>{handleEdit(e,item.id)}} className='bg-blue-900 hover:bg-blue-600 p-2 py-2 text-white md:text-xl rounded-md mx-1'><RiEdit2Fill /></button>
//                 <button onClick={(e) => { handleDelete(e, item.id) }} className='bg-blue-900 hover:bg-blue-600 p-2 py-2  text-white md:text-xl rounded-md mx-1'><MdDeleteForever /></button>
//               </div>
//             </div>
//           })}
//         </div>
